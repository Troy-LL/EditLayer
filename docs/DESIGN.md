...
| Apply to code | Writes the JSX, then Vite hot-reloads. A toast shows the change summary with **Undo**, and Ctrl/Cmd+Z works too. If Apply refuses (dynamic text, unknown shape), a red inline line points you to Ask agent |
